...
describe("AO orphan detection", () => {
  it("detects PPID=1 AO dashboard, websocket, and lifecycle processes", () => {
    const output = [
      ...
      "  90351      1 node /opt/homebrew/lib/node_modules/@slievr/web/dist-server/start-all.js",
      "  47457      1 node /opt/homebrew/lib/node_modules/@slievr/web@0.2.4/dist-server/start-all.js",
      "  47458      1 node @slievr/web@0.2.4 dist-server/start-all.js",
      "  47575      1 node /opt/homebrew/lib/node_modules/@slievr/web@0.2.4/dist-server/terminal-websocket.js",
      "  47580      1 node /opt/homebrew/lib/node_modules/@slievr/web@0.2.4/dist-server/direct-terminal-ws.js",
